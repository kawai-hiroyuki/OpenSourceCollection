...
static NSString * const kJSQDemoAvatarDisplayNameCook = @"Mike";
static NSString * const kJSQDemoAvatarDisplayNameJobs = @"Susan";
static NSString * const kJSQDemoAvatarDisplayNameWoz = @"Steve";
