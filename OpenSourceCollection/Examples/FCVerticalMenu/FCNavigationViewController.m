...
#define StoryboardName @"FCVerticalMenu"
...
- (void)configureVerticalMenu
{
    ...
    item1.actionBlock = ^{
        ...
        FCFirstViewController *vc = [[UIStoryboard storyboardWithName:StoryboardName bundle:[NSBundle mainBundle]] instantiateViewControllerWithIdentifier:@"FirstViewController"];
    ...
    item2.actionBlock = ^{
        ...
        FCSecondViewController *vc = [[UIStoryboard storyboardWithName:StoryboardName bundle:[NSBundle mainBundle]] instantiateViewControllerWithIdentifier:@"SecondViewController"];
    ...
    item4.actionBlock = ^{
        ...
        FCSecondViewController *vc = [[UIStoryboard storyboardWithName:StoryboardName bundle:[NSBundle mainBundle]] instantiateViewControllerWithIdentifier:@"ThirdViewController"];
