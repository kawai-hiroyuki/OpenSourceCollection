...
//    } else {
//        self.coverFlowView1.pageItemWidth = 180;
//        self.coverFlowView1.pageItemCoverWidth = 10.0;
//        self.coverFlowView1.pageItemHeight = 100.0;
//        self.coverFlowView1.pageItemCornerRadius = 5.0;
//    }
...
//    CFCoverFlowView *coverFlowView2 = [[CFCoverFlowView alloc] initWithFrame:CGRectMake(224, 400.0, 320.0, 120)];
    CFCoverFlowView *coverFlowView2 = [[CFCoverFlowView alloc] initWithFrame:CGRectMake(0.0, 400.0, 320.0, 120)];
