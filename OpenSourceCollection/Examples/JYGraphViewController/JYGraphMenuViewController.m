...
//                                            initWithNibName:@"JYGraphViewController" bundle:nil];
        JYGraphViewController *graphView = [[UIStoryboard storyboardWithName:NSStringFromClass([self class]) bundle:nil] instantiateViewControllerWithIdentifier:NSStringFromClass([JYGraphViewController class])];
